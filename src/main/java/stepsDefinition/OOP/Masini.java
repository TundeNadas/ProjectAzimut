...
public class Masini {
    ...
    public Masini(String marca, String culoare, String tip, int roti, int locuri, String plafon, Boolean areAsigurare, String cutieViteze, int numarTrepteViteza, int vechime){
        this.marca = marca;
